...
// representation
class ArticularPointOrCutVertex
{
    ...
    // Constructor
    ArticularPointOrCutVertex(int v)
    {
        V = v;
    ...
    public static void main(String args[])
    {
        ...
        ArticularPointOrCutVertex g1 = new ArticularPointOrCutVertex(5);
        g1.addEdge(1, 0);
        g1.addEdge(0, 2);
        g1.addEdge(2, 1);
        g1.addEdge(0, 3);
        ...
        ArticularPointOrCutVertex g2 = new ArticularPointOrCutVertex(4);
        g2.addEdge(0, 1);
        g2.addEdge(1, 2);
        g2.addEdge(2, 3);
        g2.AP();
        ...
        ArticularPointOrCutVertex g3 = new ArticularPointOrCutVertex(7);
        g3.addEdge(0, 1);
        g3.addEdge(1, 2);
        g3.addEdge(2, 0);
        g3.addEdge(1, 3);
