package com.company.amazon.BookKarumanchi.TicTackToe.Interviews;/*
package TicTackToe.Interviews;
...
public class md {
    ...
    - Why do you want to join Google?
            ...
            - What do you know about Googleâ€™s product and technology?
    ...
    - If you are Product Manager for Googleâ€™s Adwords, how do you plan to market this?
            - What would you say during an AdWords or AdSense product seminar?
            - Who are Googleâ€™s competitors, and how does Google compete with them?
    ...
    - Have you ever used Googleâ€™s products? Gmail?
    ...
    --- Google Voice
    --- YouTube
    - Whatâ€™s a creative way of marketing Googleâ€™s brand name and product?
    ...
    -- More Television commercials since most people just don't know about the products / features that Google offers and the TV is still the most used device which almost everyone has.
            - If you are the product marketing manager for Googleâ€™s Gmail product, how do you plan to market it so as to achieve 100 million customers in 6 months?
            - How much money you think Google makes daily from Gmail ads?
            - Name a piece of technology youâ€™ve read about recently. Now tell me your own creative execution for an ad for that product.
    ...
    - How would you boost the GMail subscription base?
            ...
            - How would you re-position Googleâ€™s offerings to counteract competitive threats from Microsoft?
            - How many golf balls can fit in a school bus?
            - You are shrunk to the height of a nickel and your mass is proportionally reduced so as to maintain your original density. You are then thrown into an empty glass blender. The blades will start moving in 60 seconds. What do you do?
            - How much should you charge to wash all the windows in Seattle?
            - How would you find out if a machineâ€™s stack grows up or down in memory?
            - Explain a database in three sentences to your eight-year-old nephew.
            - How many times a day does a clockâ€™s hands overlap?
    ...
    - How would you design a simple search engine?
            ...
            - Thereâ€™s a latency problem in South Africa. Diagnose it.
            ...
            - How many vacuumâ€™s are made per year in USA?
    ...
    - What is the difference between a mutex and a semaphore? Which one would you use to protect access to an increment operation?
            ...
            - Explain the significance of â€œdead beefâ€.
    ...
    - In Java, what is the difference between final, finally, and finalize?
            ...
            - Write a function (with helper functions if needed) called to Excel that takes an excel column value (A,B,C,Dâ€¦AA,AB,AC,â€¦ AAA..) and returns a corresponding integer value (A=1,B=2,â€¦ AA=26..).
            - You have a stream of infinite queries (ie: real time Google search queries that people are entering). Describe how you would go about finding a good estimate of 1000 samples from this never ending set of data and then write code for it.
    - Tree search algorithms. Write BFS and DFS code, explain run time and space requirements. Modify the code to handle trees with weighted edges and loops with BFS and DFS, make the code print out path to goal state.
    - You are given a list of numbers. When you reach the end of the list you will come back to the beginning of the list (a circular list). Write the most efficient algorithm to find the minimum # in this list. Find any given # in the list. The numbers in the list are always increasing but you donâ€™t know where the circular list begins, ie: 38, 40, 55, 89, 6, 13, 20, 23, 36.
            - Describe the data structure that is used to manage memory. (stack)
            - Whatâ€™s the difference between local and global variables?
            - If you have 1 million integers, how would you sort them efficiently? (modify a specific sorting algorithm to solve this)
            - In Java, what is the difference between static, final, and const. (if you donâ€™t know Java they will ask something similar for C or C++).
            - Talk about your class projects or work projects (pick something easy)â€¦ then describe how you could make them more efficient (in terms of algorithms).
    ...
    - You are given a game of Tic Tac Toe. You have to write a function in which you pass the whole game and name of a player. The function will return whether the player has won the game or not. First you to decide which data structure you will use for the game. You need to tell the algorithm first and then need to write the code. Note: Some position may be blank in the gameà¥¤ So your data structure should consider this condition also.
            - You are given an array [a1 To an] and we have to construct another array [b1 To bn] where bi = a1*a2*â€¦*an/ai. you are allowed to use only constant space and the time complexity is O(n). No divisions are allowed.
            ...
            - Given a Data Structure having first n integers and next n chars. A = i1 i2 i3 â€¦ iN c1 c2 c3 â€¦ cN.Write an in-place algorithm to rearrange the elements of the array ass A = i1 c1 i2 c2 â€¦ in cn
    - Given two sequences of items, find the items whose absolute number increases or decreases the most when comparing one sequence with the other by reading the sequence only once.
            - Given That One of the strings is very very long , and the other one could be of various sizes. Windowing will result in O(N+M) solution but could it be better? May be NlogM or even better?
            - How many lines can be drawn in a 2D plane such that they are equidistant from 3 non-collinear points?
            - Letâ€™s say you have to construct Google maps from scratch and guide a person standing on Gateway of India (Mumbai) to India Gate(Delhi). How do you do the same?
            - Given that you have one string of length N and M small strings of length L. How do you efficiently find the occurrence of each small string in the larger one?
            - Given a binary tree, programmatically you need to prove it is a binary search tree.
            - You are given a small sorted list of numbers, and a very very long sorted list of numbers â€“ so long that it had to be put on a disk in different blocks. - How would you find those short list numbers in the bigger one?
    ...
    - Distance is defined like this : If a[i], b[j] and c[k] are three elements then distance=max(abs(a[i]-b[j]),abs(a[i]-c[k]),abs(b[j]-c[k]))â€ Please give a solution in O(n) time complexity
    ...
    - There are some data represented by(x,y,z). Now we want to find the Kth least data. We say (x1, y1, z1) > (x2, y2, z2) when value(x1, y1, z1) > value(x2, y2, z2) where value(x,y,z) = (2^x)*(3^y)*(5^z). Now we can not get it by calculating value(x,y,z) or through other indirect calculations as lg(value(x,y,z)). How to solve it?
            ...
            - Whatâ€™s the difference between a hashtable and a hashmap?
    ...
    - How would you store 1 million phone numbers?
            - Design a 2D dungeon crawling game. It must allow for various items in the maze â€“ walls, objects, and computer-controlled characters. (The focus was on the class structures, and how to optimize the experience for the user as s/he travels through the dungeon.)
    ...
    - How would you determine if someone has won a game of tic-tac-toe on a board of any size?
            ...
            - What kind of data structure would you use to index annagrams of words? e.g. if there exists the word â€œtopâ€ in the database, the query for â€œpotâ€ should list that.
    ...
    - Youâ€™re the captain of a pirate ship, and your crew gets to vote on how the gold is divided up. If fewer than half of the pirates agree with you, you die. How do you recommend apportioning the gold in such a way that you get a good share of the booty, but still survive?
