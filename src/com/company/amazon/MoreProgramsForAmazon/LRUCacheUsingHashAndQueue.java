...
public class LRUCacheUsingHashAndQueue {
	...
	static QNode newQNode( int pageNumber )
	{
	    // Allocate memory and assign 'pageNumber'
	    QNode temp = null;//new QNode();
	...
	static // A utility function to create an empty Queue.
	// The queue can have at most 'numberOfFrames' nodes
	Queue createQueue( int numberOfFrames )
	{
	    Queue queue = null;//new Queue();
	...
	static Hash createHash( int capacity )
	{
	    ...
	    Hash hash = null;//new Hash();
	    hash.capacity = capacity;
	 
	    // Create an array of pointers for refering queue nodes
	    hash.array = new QNode[24];
	...
	static boolean AreAllFramesFull( Queue queue )
	{
	    return queue.count == queue.numberOfFrames;
	}
	 
	// A utility function to check if queue is empty
	static boolean isQueueEmpty( Queue queue )
	{
	...
	// and hash
	static void Enqueue( Queue queue, Hash hash, int pageNumber )
	{
...
//	    of queue
	...
	static void ReferencePage( Queue queue, Hash hash, int pageNumber )
	{
