...
public class DiceThrowProblem {
	static // C++ program to find number of ways to get sum 'x' with 'n'
	...
	int findWays(int m, int n, int x)
	{
	    ...
	    memset(table, 0, table.length); // Initialize all entries as 0
	...
	private static void memset(int[][] table, int i, int length) {
		for(i=0;i<length;i++){
